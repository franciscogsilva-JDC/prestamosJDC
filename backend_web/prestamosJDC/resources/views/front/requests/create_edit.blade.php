			...
			<div class="col s12 m12 l12">
				<div class="card-panel card-panel-table-factories">
			        <div class="head-edit">
			            ...
			            <div class="section ">
		                    {!! Form::open(['route' => 'requests-front.store', 'method' => 'POST', 'onsubmit' => 'preloader()']) !!}
			                	<div class="row">
			                    ...
			                    <div class="buttonpanel-edit center-align">
									<a href="{{ route('welcome') }}" class="btn waves-effect waves-light grey" onclick="return confirm('¿Desea cancelar la creación de la Solicitud?')">Cancelar</a>              
									@if(isset($request))
