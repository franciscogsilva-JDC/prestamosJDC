        ...
        <div class="row">	
			<div class="col s12 m12 l12">	
                <div class="card-panel card-panel-search-fgs">	
					...
					{!! Form::open(['route' => 'users-front.requests', 'method' => 'GET'], ['class' => 's12 m12 l12']) !!}
									...
									<tr>
										<td>
											@if($request->authorizations()->orderBy('created_at', 'DESC')->first()->approved_by)
												<b>Aprobado: </b>{{ $request->authorizations()->orderBy('created_at', 'DESC')->first()->approver->name }}<br>
											@endif
