								...
								@foreach($dependencies as $dependency)
									<tr>									
										...
										<td class="td-fgs center-align">
		                					...
		                					{!! Form::close() !!}
											@if(!$dependency->deleted_at)
												<a href="{{ route('dependencies.destroy', $dependency->id) }}" onclick="return confirm('¿Desea Inhabilitar la dependencia?')" class="btn btn-fgs btn-fgs-delete red darken-3"><i class="material-icons">visibility_off</i></a>
											@else
												<a href="{{ route('dependencies.destroy', $dependency->id) }}" onclick="return confirm('¿Desea Habilitar la dependencia?')" class="btn btn-fgs btn-fgs-delete red darken-3"><i class="material-icons">visibility</i></a>
											@endif
											<a href="{{ route('dependencies.edit', $dependency->id) }}" class="btn btn-raised btn-primary btn-fgs btn-fgs-edit"><i class="material-icons">create</i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
