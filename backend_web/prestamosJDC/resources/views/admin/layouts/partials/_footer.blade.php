<footer class="page-footer footer-fgs-cms">
		...
		<div class="row">
			<div class="col l6 s12">
				...
				<div class="col-social-buttons greysito-text">
					...
					<a href="https://www.instagram.com/universidadJDC/"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a>
	...
	<div class="footer-copyright greysito-text">
		<div class="container">
			© <?php  echo "".date("Y") ?> Fundación Universitaria Juan de Castellanos. Todos los derechos reservados. VIGILADA MINEDUCACION
		</div>
	</div>
</footer>