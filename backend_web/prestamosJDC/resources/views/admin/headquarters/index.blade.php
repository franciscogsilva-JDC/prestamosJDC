									...
									<tr>
										...
										<td class="td-fgs center-align">
											...
											@if(!$headquarter->deleted_at)
												<a href="{{ route('headquarters.destroy', $headquarter->id) }}" onclick="return confirm('¿Desea Inhabilitar la sede?')" class="btn btn-fgs btn-fgs-delete red darken-3 tooltipped" data-position="top" data-delay="50" data-tooltip="Inhabilitar"><i class="material-icons">delete</i></a>
											@else
												<a href="{{ route('headquarters.destroy', $headquarter->id) }}" onclick="return confirm('¿Desea Habilitar la sede?')" class="btn btn-fgs btn-fgs-delete grey darken-2 tooltipped" data-position="top" data-delay="50" data-tooltip="Habilitar"><i class="material-icons">update</i></a>
											@endif
											<a href="{{ route('headquarters.edit', $headquarter->id) }}" class="btn btn-raised btn-primary btn-fgs btn-fgs-edit tooltipped" data-position="top" data-delay="50" data-tooltip="Editar"><i class="material-icons">create</i></a>
										</td>
									</tr>
								@endforeach
							</tbody>
